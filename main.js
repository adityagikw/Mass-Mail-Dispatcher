...
function sendEmail() {
    Email.send({
        ...
        Username: "adityagikw@gmail.com", 
        Password: "B5206F9DCB5B3D9E7516F3DA8724B2ECCB47",  
        To: "adityagikw@gmail.com",
        From: "adityagikw@gmail.com",
        Subject: document.querySelector('#subject').value,
        Body: document.getElementById('msg').value
    }).then(
        message => alert(Window.valNo + " mails has been sent successfully, press ok to continue ")
    );
